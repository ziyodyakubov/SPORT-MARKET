                ...
                <div className="flex items-center sm:flex-col justify-between gap-[24px] mb-[80px]">
                    ...
                    <div className="title sm:pt-[30px] sm:pl-[20px] pt-[50px] bg-[#fff] sm:w-full rounded-[5px] sm:h-[490px] w-[503px] h-[539px] pl-[52px] pr-[80px] pb-[34px]">
                        ...
                        <div className="flex items-center gap-[21px] sm:gap-[10px] sm:mt-[50px] mb-[32px]">
                            <button className="flex items-center gap-[5px] sm:py-[10px] sm:px-[15px] py-[20px] px-[30px] border-[2px] border-[#FBD029] transition-all duration-300 hover:bg-[#FBD029] active:bg-[#fff] rounded-[5px] bg-[#fff]"><Image src={Add} alt="add" />Корзина</button>
                            <button className="flex items-center gap-[5px] sm:py-[10px] sm:px-[15px] py-[20px] px-[30px] border-[2px] border-[#FBD029] transition-all duration-300 hover:bg-[#FBD029] active:bg-[#fff] rounded-[5px] bg-[#fff]"><Image src={Control} alt="control" />Сравнить</button>
                        </div>
