...
export default function HomeNavButton() {
    ...
    return (
     <div className="flex items-center sm:gap-[5px] gap-[11px]">
         <div onClick={handleNavigate} className="cursor-pointer flex items-center gap-[5px]">
            <i className='bx text-[12px] bx-home-alt' ></i>
            <h3 className="text-[16px] sm:text-[12px] opacity-[0.6]">Главная</h3>
        </div>
        ...
        <div onClick={handleNavigate2} className='cursor-pointer flex items-center gap-[5px]'>
            ...
            <h3 className="text-[16px] sm:text-[12px] opacity-[0.6]">Продукты</h3>
        </div>
     </div>
    );
}