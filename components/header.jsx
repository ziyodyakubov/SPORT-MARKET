      ...
      <div className="pt-[10px] sm:p-[15px] pb-[13px] bg-[#1F1D14]">
        <nav className="container flex items-center justify-between">
          <div className="left flex items-center gap-[30px] sm:gap-[190px]">
              <a href="/" className="flex gap-[11px] cursor-pointer"><Image className='sm:w-[50px]' src={Logo} alt="logo" />
              ...
              <i className='bx bx-menu sm:text-[30px] sm:block sm:text-[#fff] cursor-pointer'></i>
      ...
      <div className="container sm:p-[15px] py-[15px] bg-[#Fff]">
        <ul className="flex items-center justify-between">
          <li className="flex items-center sm:gap-[10px] gap-[10px]">
            <button className="flex items-center sm:gap-[5px] gap-[10px] hover:bg-[#1f1d14df] transition-all duration-300 active:bg-[#1F1D14] rounded-[5px] sm:text-[14px] text-[20px] text-[#Fff] bg-[#1F1D14] sm:px-[20px] sm:py-[10px] px-[40px] py-[15px]"><Image className='sm:w-[10px]' src={Katalog} alt="katalog" />Каталог</button>
          ...
          <li className="flex items-center sm:gap-[7px] gap-[13px]">
            ...
            <button onClick={handleNav} className="px-[30px] sm:py-[8px] sm:hidden sm:px-[20px] h-[45px] py-[25px] hover:bg-[#CCCCCC] active:bg-[#F2F2F2] transition-all duration-300  rounded-[5px] bg-[#F2F2F2] cursor-pointer flex items-center gap-[10px]"><Image src={Add} alt="korzinka" />Корзина</button>
